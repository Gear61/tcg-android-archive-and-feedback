...
object MeetingsLessonProvider {
    ...
    private fun getLesson6(context: Context): Lesson {
        ...
        return Lesson(
            id = lessonId,
            tags = setOf(LessonTag.MEETINGS, LessonTag.ONE_ON_ONE_MEETINGS),
    ...
    private fun getLesson10(context: Context): Lesson {
        ...
        return Lesson(
            id = lessonId,
            tags = setOf(LessonTag.MEETINGS, LessonTag.ONE_ON_ONE_MEETINGS, LessonTag.WORKING_WITH_MANAGER),
    ...
    private fun getLesson13(context: Context): Lesson {
        ...
        return Lesson(
            ...
            tags = setOf(
                LessonTag.MEETINGS,
                LessonTag.ONE_ON_ONE_MEETINGS,
                LessonTag.WORKING_WITH_MANAGER,
                LessonTag.JUNIOR_ENGINEER
            ),
