...
object MeetingsLessonProvider {
    ...
    private fun getLesson1(context: Context): Lesson {
        ...
        questions.add(
            Question(
                textResId = R.string.meetings_question_1,
                optionsListResId = R.array.meetings_question_1_options,
                correctAnswerId = R.string.meetings_question_1_option_2
            )
        )
        questions.add(
            Question(
                textResId = R.string.meetings_question_2,
        ...
        questions.add(
            Question(
                textResId = R.string.meetings_question_3,
                optionsListResId = R.array.meetings_question_3_options,
                correctAnswerId = R.string.meetings_question_3_option_1
            )
        )
        questions.add(
            Question(
                textResId = R.string.meetings_question_4,
                optionsListResId = R.array.true_false_options,
        ...
        questions.add(
            Question(
                textResId = R.string.meetings_question_5,
                optionsListResId = R.array.meetings_question_5_options,
                correctAnswerId = R.string.meetings_question_5_option_2
            )
        )
